...
.AddJwtBearer("JwtBearer", options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("biblioteca-chave-autenticacao-webapi-dev_codeFirst")),

        //Valida o tempo de expiração do token
        ClockSkew = TimeSpan.FromMinutes(5),

        //De onde está vindo (qual o issure)
        ValidIssuer = "biblioteca.webApi",

        //Para onde está indo (qual o audiece)
        ValidAudience = "biblioteca.webApi"
    };
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        //Descrição da API
        Description = "API para simulação de uma Biblioteca.",
