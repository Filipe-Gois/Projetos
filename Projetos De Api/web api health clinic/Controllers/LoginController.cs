        ...
        public IActionResult Login(LoginViewModel usuario)
        {
            try
            {
                ...
                if (usuarioBuscado != null)
                {
                    ...
                    var key = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("healthClinic-chave-autenticacao-webapi-dev_codeFirst"));
                    ...
                    var token = new JwtSecurityToken(
                        ...
                        issuer: "healthClinic.webApi_codeFirst",

                        //destinatário do token - quem vai recebr este token
                        audience: "healthClinic.webApi_codeFirst",
